...
namespace MyDesignForm //AllocationRequest
{
    ...
    class NRPrinter
    {
        ...
        public NRPrinter(String userbasepath, String userlogname)
        {
    ...
    class LogWriter
    {
        ...
        /// <param name="name"></param>
        public static void Write(String from, NRPrinter.Categories category, String msg, String path, String name)
        {
    ...
    public class DGVPrinter
    {
        ...
        public Boolean EnableLogging
        {
            ...
            set
            {
                ...
                if (enablelogging)
                {
                    Logger = new NRPrinter(".", "DGVPrinter");
                }
            }
        }
